...
void BOARD_InitPins(void)
{
    ...
    //PWM pins for the servomotor + DC motor (from exp 1)
    PORT_SetPinMux(PORTC, 1U, kPORT_MuxAlt4);
    PORT_SetPinMux(PORTA, 6U, kPORT_MuxAlt3);

    //UART PINS: SEND AND RECEIVE then CTS AND rts
    PORT_SetPinMux(PORTC, 13U, kPORT_MuxAlt3); //idk how samarth got these specific ports but apparently he got them from the ta idk
    PORT_SetPinMux(PORTC, 14U, kPORT_MuxAlt3);
    PORT_SetPinMux(PORTC, 15U, kPORT_MuxAlt3);
    PORT_SetPinMux(PORTE, 27U, kPORT_MuxAlt3); // UART4 RTS B
